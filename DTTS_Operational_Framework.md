...
```mermaid
flowchart TB
    PLAN["PLAN - Market Leadership (Business Owner)"]
    DDTS["Director of Data & Technology Services (Market Liaison & Oversight)"]
    IT["Shared IT Services (System Changes & Deployments)"]
    EA["Enterprise Analytics (Reporting & Analytics Delivery)"]
    STATE["STATE Technology Team "]

    PLAN -->|"Strategy, Business Priorities, Funding, Outcomes"| DDTS
    DDTS -->|"Requirements, Prioritization, Market Oversight"| IT
    DDTS -->|"Reporting Needs, Validation & Priorities"| EA
    DDTS -->|"File Submissions, Data Exchanges, IT Coordination"| STATE
    IT -->|"Implemented Systems, Platform Changes"| DDTS
    EA -->|"Reports & Analytics"| DDTS
    STATE -->|"IT Requirements, File Specifications, Feedback"| DDTS
    DDTS -->|"Adoption, Status, Risk & Outcomes"| PLAN
```
